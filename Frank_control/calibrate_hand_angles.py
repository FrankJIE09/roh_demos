...
def print_calibration_results(calibration_ranges):
    ...
    print("# NOTE: 'Bend Angle Straight/Bent' maps to bend metric (0=straight), 'Thumb Rot Min/Max' maps to rotation angle")
        ...
        while True:
            ...
            if results.multi_hand_landmarks:
                ...
                try:
                    ...
                    pip = calculate_angle_3d(landmarks[mp.solutions.hands.HandLandmark.INDEX_FINGER_MCP], landmarks[mp.solutions.hands.HandLandmark.INDEX_FINGER_PIP], landmarks[mp.solutions.hands.HandLandmark.INDEX_FINGER_DIP])
                    dip = calculate_angle_3d(landmarks[mp.solutions.hands.HandLandmark.INDEX_FINGER_PIP], landmarks[mp.solutions.hands.HandLandmark.INDEX_FINGER_DIP], landmarks[mp.solutions.hands.HandLandmark.INDEX_FINGER_TIP])
                    current_metrics["Index Bend"] = (180.0 - pip) + (180.0 - dip) if pip > 0 and dip > 0 else 0
                    # Middle
                    pip = calculate_angle_3d(landmarks[mp.solutions.hands.HandLandmark.MIDDLE_FINGER_MCP], landmarks[mp.solutions.hands.HandLandmark.MIDDLE_FINGER_PIP], landmarks[mp.solutions.hands.HandLandmark.MIDDLE_FINGER_DIP])
                    dip = calculate_angle_3d(landmarks[mp.solutions.hands.HandLandmark.MIDDLE_FINGER_PIP], landmarks[mp.solutions.hands.HandLandmark.MIDDLE_FINGER_DIP], landmarks[mp.solutions.hands.HandLandmark.MIDDLE_FINGER_TIP])
                    current_metrics["Middle Bend"] = (180.0 - pip) + (180.0 - dip) if pip > 0 and dip > 0 else 0
                    # Ring
                    pip = calculate_angle_3d(landmarks[mp.solutions.hands.HandLandmark.RING_FINGER_MCP], landmarks[mp.solutions.hands.HandLandmark.RING_FINGER_PIP], landmarks[mp.solutions.hands.HandLandmark.RING_FINGER_DIP])
                    dip = calculate_angle_3d(landmarks[mp.solutions.hands.HandLandmark.RING_FINGER_PIP], landmarks[mp.solutions.hands.HandLandmark.RING_FINGER_DIP], landmarks[mp.solutions.hands.HandLandmark.RING_FINGER_TIP])
                    current_metrics["Ring Bend"] = (180.0 - pip) + (180.0 - dip) if pip > 0 and dip > 0 else 0
                    # Pinky
                    pip = calculate_angle_3d(landmarks[mp.solutions.hands.HandLandmark.PINKY_MCP], landmarks[mp.solutions.hands.HandLandmark.PINKY_PIP], landmarks[mp.solutions.hands.HandLandmark.PINKY_DIP])
                    dip = calculate_angle_3d(landmarks[mp.solutions.hands.HandLandmark.PINKY_PIP], landmarks[mp.solutions.hands.HandLandmark.PINKY_DIP], landmarks[mp.solutions.hands.HandLandmark.PINKY_TIP])
                    current_metrics["Pinky Bend"] = (180.0 - pip) + (180.0 - dip) if pip > 0 and dip > 0 else 0
                    # Thumb Bend
                    mcp = calculate_angle_3d(landmarks[mp.solutions.hands.HandLandmark.THUMB_CMC], landmarks[mp.solutions.hands.HandLandmark.THUMB_MCP], landmarks[mp.solutions.hands.HandLandmark.THUMB_IP])
                    ip = calculate_angle_3d(landmarks[mp.solutions.hands.HandLandmark.THUMB_MCP], landmarks[mp.solutions.hands.HandLandmark.THUMB_IP], landmarks[mp.solutions.hands.HandLandmark.THUMB_TIP])
                    current_metrics["Thumb Bend"] = (180.0 - mcp) + (180.0 - ip) if mcp > 0 and ip > 0 else 0

                    # Calculate Thumb Rotation Angle
                    current_metrics["Thumb Rotation"] = calculate_thumb_rotation_xy_angle(landmarks[mp.solutions.hands.HandLandmark.WRIST],
            ...
            cv2.putText(info_area, instr_text, (10, 25), FONT_FACE, FONT_SCALE_INSTR, (0, 255, 255), FONT_THICKNESS, cv2.LINE_AA)
            ...
            cv2.putText(info_area, "Current Values:", (col1_x, y_start), FONT_FACE, FONT_SCALE_INSTR, (255, 255, 0), FONT_THICKNESS, cv2.LINE_AA) # Cyan title
            cv2.putText(info_area, "Recorded Range (Min / Max):", (col2_x, y_start), FONT_FACE, FONT_SCALE_INSTR, (0, 255, 0), FONT_THICKNESS, cv2.LINE_AA) # Green title
            ...
            for i, internal_key in enumerate(INTERNAL_METRIC_KEYS):
                ...
                cv2.putText(info_area, f"{internal_key}: {val_str}", (col1_x, y_offset + i*line_height), FONT_FACE, FONT_SCALE_VALUE, (255, 255, 0), FONT_THICKNESS, cv2.LINE_AA)
                ...
                cv2.putText(info_area, f"{internal_key}: {min_val_str} / {max_val_str}", (col2_x, y_offset + i*line_height), FONT_FACE, FONT_SCALE_VALUE, (0, 255, 0), FONT_THICKNESS, cv2.LINE_AA)
            ...
            elif key == ord('o'): print("Info: Hold hand OPEN/STRAIGHT pose...")
            elif key == ord('c'): print("Info: Hold hand CLOSED/FIST pose...")
            elif key == ord('i'): print("Info: Hold thumb IN/ADDUCTED pose...")
            elif key == ord('t'): print("Info: Hold thumb OUT/ABDUCTED pose...")
